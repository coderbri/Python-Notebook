...
reps = 0                # repetition counter to track work/break cycles
...
def start_timer():
    ...
    - Odd reps (1, 3, 4, 7): Start a work session.
    - Even reps (2, 4, 6): Start a short break.
    - 8th rep: Start a long break.
    """
    global reps
...
def countdown(count):
    ...
    When finished, automatically start the next session in the Pomodoro cycle.
    """
